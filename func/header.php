    ...
    <header id="header">
        <div class="topnav d-flex justify-content-end px-4 py-1">
            <div class="font-size-14">
                ...
                <a href="./manage.php" class="px-3 border-start text-dark">Quản lý</a>
            </div>
        </div>
        ...
        <nav class="navbar navbar-expand-lg px-3 navbar-dark color-second-bg">
            ...
            <a class="navbar-brand" href="./index.php">TrungTruc Mobile</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav m-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./index.php#top-sale">Sản phẩm bán chạy</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./index.php#special-price">Giảm giá đặc biệt</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./index.php#new-phones">Những sản phẩm mới</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="./index.php#blogs">Tin tức</a>
                    </li>
                    <li class="nav-item">
